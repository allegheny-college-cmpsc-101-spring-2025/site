...
TODO: What happens if you try to print `print(f"{value} squared is {answer}")`? Copy the code and paste it below.
...
```{.markdown code-preview="code/pyodide.qmd" width="780" height="500"}
```
